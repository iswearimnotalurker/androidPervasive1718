...
@Parcelize
data class Task(val id: Int = 0, val sessionId: Int, val operatorCF: String, @KlaxonDate val startTime: Timestamp, @KlaxonDate val endTime: Timestamp, val activityId: Int, var statusId: Int): Parcelable {
    companion object {
        fun emptyTask(): Task =
